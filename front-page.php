            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <div class="entry-content">
                            <p>We train approaches to problem solving, commonly used in design and management frameworks that develops solutions to problems by involving the human perspective in all steps of the problem-solving process</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <div class="entry-content">
                            <p>Any skill that is useful in your life can be considered a life skill. Tying your shoe laces, swimming, driving a car and using a computer are, for most people, useful life skills. Broadly speaking, the term ‘life skills’ is usually used for any of the skills needed to deal well and effectively with the challenges of life.</p>
                        </div>
                    </div>
                </div>
            </div><!-- .row -->
    ...
    <div class="home-page-events">
        <div class="container">
            <div class="row">
                ...
                <?php echo do_shortcode("[l_upcoming_events]"); ?>
                </div><!-- .col -->


                <div class="col-12 col-lg-6">
                  <?php  echo do_shortcode("[innovation_of_the_year]"); ?>
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-events -->

    <?php  echo do_shortcode("[lastest_stories]"); ?>
