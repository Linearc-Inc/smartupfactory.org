        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="news-content">
                        ...
                        <header class="entry-header d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="donate-icon">
                                <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/donate-icon.png" alt=""></a>
                            </div>
                        </header>
                    ...
                    <div class="news-content">
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/2.jpg" alt=""></a>
                    ...
                    <div class="news-content">
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/3.jpg" alt=""></a>
                ...
                <div class="col-12 col-lg-4">
                    <div class="sidebar">
                        ...
                        <div class="popular-posts">
                            ...
                            <ul class="p-0">
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/p-1.jpg" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/p-2.jpg" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/p-3.jpg" alt=""></a></figure>
                        ...
                        <div class="upcoming-events">
                            ...
                            <ul class="p-0">
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/u-1.jpg" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/u-2.jpg" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/u-3.jpg" alt=""></a></figure>
                        ...
                        <div class="featured-cause">
                            ...
                            <div class="cause-wrap">
                                <figure class="m-0 position-relative">
                                    <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/cause-3.jpg" alt=""></a>
                                </figure>
        ...
        <div class="footer-bar">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p class="m-0">
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://linearc.biz" target="_blank">Linearc</a>
                        </p>
                    </div><!-- .col-12 -->
                </div><!-- .row -->
            </div><!-- .container -->
